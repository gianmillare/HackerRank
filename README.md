...
| Problem Set | Solution | Difficulty |
| ------------- | ------------- | ------------- |
| [The Minion Game](https://www.hackerrank.com/challenges/the-minion-game/problem) | [Python](https://github.com/gianmillare/HackerRank/blob/master/python/medium/the_minion_game.py) |
